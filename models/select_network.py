...
def define_G(opt, use_nsml):
    ...
    # ----------------------------------------
    # SwinIR -- No shifted window version
    # ----------------------------------------
    elif net_type == 'noswinir':
    ...
    # ----------------------------------------
    # SwinIR -- blocked window version
    # ----------------------------------------
    elif net_type == 'blockswinir':
        from models.network_blockswinir import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    # ----------------------------------------
    # SwinIR -- blocked window version w/o shift
    # ----------------------------------------
    elif net_type == 'blocknoswinir':
        from models.network_blocknoswinir import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    # ----------------------------------------
        ...
        from models.network_noattnir import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'gumbel_simple_comp2':
        from models.network_onlyattnnoir_gumbel_compensate2_simple import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'gumbel_simple2':
        from models.network_onlyattnnoir_gumbel_simple2 import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'gumbel_simple2_comp1':
    ...
    elif net_type == 'gumbel_simple2_comp2':
    ...
    elif net_type == 'gumbel_simple2_comp2_wsfmax':
        from models.network_onlyattnnoir_gumbel_compensate2_simple2_wsfmax import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'kmeans_simple2_comp2':
        from models.network_onlyattnnoir_kmeans_compensate2_simple2 import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'random_simple2_comp2':
        from models.network_onlyattnnoir_random_compensate2_simple2 import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'gumbel_toosimple':
